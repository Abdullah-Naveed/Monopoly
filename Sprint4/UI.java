...
public class UI {
	...
	public static final int ERR_BANKRUPTCY = 21;
	public static final int ERR_MORTGAGE_SELL = 22;
	...
	private final String[] errorMessages = {
		...
		"Error: You must declare yourself bankrupt for game to proceed",
		"Error: You must mortgage or sell property to proceed"
	};
...
// DISPLAY METHODS
	...
	public void displayError (int errorId) {
		...
		infoPanel.displayString("Valid commands: roll, buy, build, demolish, mortgage, redeem, bankrupt, property, balance, done, quit.");
		return;
	}
