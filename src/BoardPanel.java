...
class BoardPanel extends JPanel {
	...
	private ArrayList<Player> players; // This is the declaration of the arraylist of players
	...
	BoardPanel(ArrayList<Player> players) 
	{
		...
		try 
		{
			boardImage = ImageIO.read(new File("/Users/moedagari/Desktop/board.jpg")); // Location of the image
